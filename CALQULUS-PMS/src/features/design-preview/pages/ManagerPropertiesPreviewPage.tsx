...
import { ManagerPropertiesPreview } from "@/features/design-preview/components/ManagerPropertiesPreview";
import { PUBLIC_ROUTES } from "@/features/marketing/publicConfig";
import { portalSurfaceProps } from "@/core/design";

export default function ManagerPropertiesPreviewPage() {
  useEffect(() => {
    document.title = "CALQULUS PMS | Manager properties preview";
  }, []);

  return (
    <div className="min-h-screen bg-background text-foreground" {...portalSurfaceProps("manager")}>
      <a
        href="#manager-properties-preview"
      ...
      <header className="border-b border-border bg-card">
        <div className="mx-auto flex max-w-[1440px] flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6">
          <BrandMark size="nav" showWordmark subtitle="Manager properties preview" forcePlatform />
          <p className="type-meta hidden sm:block">Phase 2 — layout chrome, not invented metrics</p>
