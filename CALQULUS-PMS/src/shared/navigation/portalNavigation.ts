...
export const MANAGER_MOBILE_NAV: PortalDeskNavItem[] = [
  { label: "Home", href: "/", icon: LayoutDashboard },
  { label: "Properties", href: "/properties", icon: Building2, permission: "view_properties" },
  { label: "Tenants", href: "/tenants", icon: Users, permission: "view_tenants" },
  { label: "Money", href: "/billing", icon: CreditCard, permission: "view_invoices" },
];

export const AGENCY_MOBILE_NAV: PortalDeskNavItem[] = [
  { label: "Home", href: AGENCY_ROUTES.dashboard, icon: LayoutDashboard },
  { label: "Clients", href: AGENCY_ROUTES.clients, icon: Handshake },
  { label: "Portfolio", href: AGENCY_ROUTES.portfolio, icon: Building2 },
  { label: "Money", href: AGENCY_ROUTES.billing, icon: CreditCard },
];

export const LANDLORD_MOBILE_NAV: PortalDeskNavItem[] = [
  { label: "Home", href: LANDLORD_ROUTES.dashboard, icon: LayoutDashboard },
  { label: "Portfolio", href: LANDLORD_ROUTES.portfolio, icon: Building2 },
  { label: "Money", href: LANDLORD_ROUTES.financials, icon: BarChart3 },
  { label: "Repairs", href: LANDLORD_ROUTES.maintenance, icon: Wrench },
];

export const WEBHOST_MOBILE_NAV: PortalDeskNavItem[] = [
  { label: "Home", href: WEBHOST_ROUTES.dashboard, icon: LayoutDashboard },
  { label: "Users", href: WEBHOST_ROUTES.users, icon: Users, permission: "can_manage_managers" },
  { label: "Ops", href: WEBHOST_ROUTES.operations, icon: Activity, permission: "can_manage_platform_settings" },
  { label: "Money", href: WEBHOST_ROUTES.subscriptions, icon: CreditCard, permission: "can_manage_billing" },
];
