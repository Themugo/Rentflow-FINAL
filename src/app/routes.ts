...
export const roleRouteConfigs: RoleRouteConfig[] = [
  {
    ...
    routes: [
      ...
      { path: "/webhost/applications", element: AdminApplications, protected: true, minAdminLevel: "admin", requirePermission: "can_manage_platform_settings" },
      { path: "/webhost/applications/:appId", element: AdminApplicationDetail, protected: true, minAdminLevel: "admin", requirePermission: "can_manage_platform_settings" },
      { path: "/webhost/deployments", element: AdminDeployments, protected: true, minAdminLevel: "admin", requirePermission: "can_manage_platform_settings" },
      { path: "/webhost/operations", element: AdminOperations, protected: true, minAdminLevel: "admin", requirePermission: "can_manage_platform_settings" },
      ...
      { path: "/webhost/users", element: AdminUsers, protected: true, minAdminLevel: "admin", requirePermission: "can_manage_managers" },
      ...
      { path: "/webhost/settings", element: AdminSettings, protected: true, minAdminLevel: "admin", requirePermission: "can_manage_platform_settings" },
      { path: "/webhost/brand", element: AdminBrandStudio, protected: true, minAdminLevel: "admin", requirePermission: "can_manage_platform_settings" },
